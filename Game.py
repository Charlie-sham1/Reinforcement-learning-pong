...
class GameInformation:
    def __init__(self,right_hits, left_hits, right_score, left_score):
...
class Game:
    ...
    def __init__(self, window, window_width, window_height):
        ...
        self.left_paddle = Paddle(20,self.window_height//2 - Paddle.HEIGHT//2)
        self.right_paddle = Paddle(window_width - 40,self.window_height//2 - Paddle.HEIGHT//2)
    ...
    def move_paddle(self, right = True, up = True):
        if right:
            if up:
                ...
                if self.right_paddle.y + Paddle.HEIGHT > self.window_height:
                    return False
            ...
            if up:
                ...
                if self.left_paddle.y + Paddle.HEIGHT > self.window_height:
                    return False
        ...
        if ball.x_vel < 0:
            if ball.y >= left_paddle.y and ball.y <= left_paddle.y + Paddle.HEIGHT:
                if ball.x - ball.RADIUS <= left_paddle.x + Paddle.WIDTH:
                    ...
                    reduction_factor = (Paddle.HEIGHT / 2) / ball.VEL
